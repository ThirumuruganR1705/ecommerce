                ...
                <div className="md:w-1/2">
                    ...
                    <div className={!reg ? "flex flex-col gap-5 mt-5 md:mt-10" : "flex flex-col gap-1 mt-5 md:mt-10"}>
                        {reg && <div className="md:mr-20 h-12 border flex pl-4 gap-4">
                            ...
                            <input className="text-lg w-full" type="email" placeholder="Username" />
                        </div>}
                        <div className="md:mr-20 h-12 border flex pl-4 gap-4">
                            <div className="h-12 flex items-center">
                                <FontAwesomeIcon icon={faEnvelope} size="lg" />
                            </div>
                            <input className="text-lg w-full" type="email" placeholder="Email" />
                        </div>
                        <div className="md:mr-20 h-12 border flex px-4 gap-4">
                            <div className="h-12 flex items-center">
                                <FontAwesomeIcon icon={faLock} size="lg" />
                            </div>
                            <input className="text-lg w-full" type="password" placeholder="Password" />
                        </div>
                        <div className="md:mt-5 flex gap-5">
                            <button className="px-4 py-2 md:px-16 md:py-5 border bg-blue-400 hover:bg-blue-500 text-white rounded-full font-bold">{!reg ? "LOGIN" : "SIGN IN"}</button>
