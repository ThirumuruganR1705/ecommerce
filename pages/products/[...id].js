                ...
                <div className="flex justify-center md:w-1/2">
                    <div className="flex justify-center gap-2 md:w-auto">
                        ...
                        <div className={maxIndex > index + 1 ? "flex items-center" : "invisible"}>
                            <FontAwesomeIcon icon={faChevronRight} className="h-6 border py-1 px-2 rounded-full text-orange-600 cursor-pointer" onClick={() => { setIndex(index + 1) }} />
                        </div>
                    </div>
                </div>
                <div className="md:w-1/2 flex flex-col gap-2">
                    <div className="text-center md:text-left md:text-xl py-2 font-bold text-orange-500">
